        ...
        try:
            if self._cpu_initialized:
                ...
                if cpu_percent >= 0:
                    ...
                    smoothed_cpu = (self._cpu_ema_alpha * normalized_cpu + 
                                  (1 - self._cpu_ema_alpha) * self._last_cpu_ema)
...
class QEffMemoryProfiler:
    ...
    def __init__(self, sampling_interval: float = 0.05, output_file: Optional[str] = None, 
