...
_two_phase_session = os.environ.get("QEFF_PER_PR_SHARED_HOME") or os.environ.get("QEFF_PER_PR_COMPILE_WARM_ONLY")
if _xdist_worker and os.environ.get("QEFF_HOME") and not _two_phase_session:
