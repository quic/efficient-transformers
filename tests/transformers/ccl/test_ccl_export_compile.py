...
def test_causal_lm_unsupported(cb):
    ...
    ctx_len = 32
    comp_ctx_lengths_prefill = [16]
    comp_ctx_lengths_decode = [24, ctx_len]
    with pytest.warns():
...
def test_causal_lm_init(config, cb):
    ...
    with pytest.raises(TypeError):
        QEFFAutoModelForCausalLM(
            AutoModel.from_config(config, **model_kwargs),
            cb,
            comp_ctx_lengths_prefill=comp_ctx_lengths_prefill,
            comp_ctx_lengths_decode=comp_ctx_lengths_decode,
            ctx_len=ctx_len,
...
def test_causal_lm_export_and_hash(config, cb, tmp_path):
    ...
    comp_ctx_lengths_prefill = [16]
    comp_ctx_lengths_decode = [24, ctx_len]
    model_0_0 = QEFFAutoModelForCausalLM(
    ...
    model_0_1 = QEFFAutoModelForCausalLM(
        AutoModelForCausalLM.from_config(config, **model_kwargs),
        cb,
        comp_ctx_lengths_prefill=comp_ctx_lengths_prefill,
        comp_ctx_lengths_decode=comp_ctx_lengths_decode,
    ...
    model_1_0 = QEFFAutoModelForCausalLM(
        AutoModelForCausalLM.from_config(cfg1, **model_kwargs),
        cb,
        comp_ctx_lengths_prefill=comp_ctx_lengths_prefill,
        comp_ctx_lengths_decode=comp_ctx_lengths_decode,
        ctx_len=ctx_len,
    ...
    model_1_1 = QEFFAutoModelForCausalLM(
        AutoModelForCausalLM.from_config(cfg2, **model_kwargs),
        cb,
        comp_ctx_lengths_prefill=comp_ctx_lengths_prefill,
        comp_ctx_lengths_decode=comp_ctx_lengths_decode,
        ctx_len=ctx_len,
    ...
    if cb:
        model_0_no_cb = QEFFAutoModelForCausalLM(
            AutoModelForCausalLM.from_config(config, **model_kwargs),
            False,
            comp_ctx_lengths_prefill=comp_ctx_lengths_prefill,
            comp_ctx_lengths_decode=comp_ctx_lengths_decode,
