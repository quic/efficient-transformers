...
def check_causal_lm_pytorch_vs_kv_vs_ort_vs_ai100(
    ...
    prompts = Constants.INPUT_STR * full_batch_size if continuous_batching else prompts
    ...
    with _model_export_compile_lock(model_name):
        ...
        if not compile_only and continuous_batching is False and not skip_onnxruntime:
