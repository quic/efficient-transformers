...
def test_simple_prefix_caching(model_name):
    ...
    suffixes2 = ["a little girl", "in a bustling city"]  # noqa: F841

    tokenizer = AutoTokenizer.from_pretrained(model_name)

    generator = TextGeneration(tokenizer=tokenizer, qpc_path=qeff_model.qpc_path, full_batch_size=2, ctx_len=256)  # noqa: F841

    prompts = [pref + suff for pref, suff in zip(prefixes, suffixes1)]  # noqa: F841
