...
with open(CONFIG_PATH, "r") as f:
    ...
    multimodal_models = config_data["image_text_models_blocked"]
...
def test_full_image_text_to_text_pytorch_vs_kv_vs_ort_vs_ai100(model_name, kv_offload, blocking_mode, manual_cleanup):
    NUM_KV_BLOCKS = 2
    HEAD_BLOCK_SIZE = 8
    NUM_Q_BLOCKS = 2
...
@pytest.mark.parametrize("model_name", test_mm_models)
@pytest.mark.parametrize("kv_offload", [True, False])
@pytest.mark.parametrize("blocking_mode", ["hqkv"])
def test_few_image_text_to_text_pytorch_vs_kv_vs_ort_vs_ai100(model_name, kv_offload, blocking_mode, manual_cleanup):
    NUM_KV_BLOCKS = 2
    HEAD_BLOCK_SIZE = 8
    NUM_Q_BLOCKS = 2
...
@pytest.mark.parametrize("kv_offload", [True, False])
@pytest.mark.parametrize("blocking_mode", ["q", "kv", "qkv", "hqkv"])
def test_dummy_image_text_to_text_blocked_pytorch_vs_kv_vs_ort_vs_ai100(
    model_name, kv_offload, blocking_mode, manual_cleanup
):
    NUM_KV_BLOCKS = 2
    HEAD_BLOCK_SIZE = 8
    NUM_Q_BLOCKS = 2
...
@pytest.mark.parametrize("model_name", test_mm_models)
@pytest.mark.parametrize("kv_offload", [True, False])
def test_dummy_image_text_to_text_headpar_blocked_pytorch_vs_kv_vs_ort_vs_ai100(model_name, kv_offload, manual_cleanup):
    NUM_KV_BLOCKS = 2
...
@pytest.mark.parametrize("model_name", test_mm_models)
@pytest.mark.parametrize("kv_offload", [True, False])
def test_dummy_image_text_to_text_batch_fold_blocked_pytorch_vs_kv_vs_ort_vs_ai100(
    model_name, kv_offload, manual_cleanup
):
    NUM_KV_BLOCKS = 2
