...
class InternProcessor():
    ...
    def __call__(self, pixel_values,
             question, history=None, return_history=False,
...
pixel_values = internProcessor.load_image('/local/mnt/workspace/open-source/efficient-transformers/image1.jpg', max_num=12)
question = "<image>\n" + prompt
