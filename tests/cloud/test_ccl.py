...
## Using comp_ctx_lengths variable you can pass a list of context lengths. ##
...
comp_ctx_lengths = [512, 1024, 2048, 4096, 8192, 16384, 32768]
...
# model.compile(prefill_seq_len=128, ctx_len=32768, comp_ctx_lengths=comp_ctx_lengths, num_cores=16, num_devices=1,batch_size=4)
