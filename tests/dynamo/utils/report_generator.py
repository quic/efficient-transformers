...
_COLUMN_SHORT: Dict[str, str] = {
    ...
    "QAIC_Generate_Execute": "QAIC Run",
    "CPU_Parity": "CPU Parity",
    "HW_Parity_FP16": "HW Parity FP16",
    "CB_Dynamo_Subfn": "CB",
    "Subfunction_Coverage": "Subfn",
    "FP32_Coverage": "FP32",
    "FP16_Coverage": "FP16",
    "BF16_Coverage": "BF16",
    "MXFP6_Coverage": "MXFP6",
    "MXINT8_Coverage": "MXINT8",
    "CCL_Coverage": "CCL",
    "Blocking_KV_Coverage": "Blocking-KV",
    "Sampler_Coverage": "Sampler",
    "Prefix_Caching_Coverage": "Prefix Cache",
}
