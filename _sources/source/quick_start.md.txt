...
```bash
python -m QEfficient.cloud.infer --model_name TinyLlama/TinyLlama_v1.1 --batch_size 1 --prompt_len 32 --ctx_len 128 --num_cores 16 --device_group [0] --prompt "My name is|The flat earth 
