    ...
    def forward(
        ...
        **kwargs,
        ...
        if past_key_value is not None:
            ...
            key_states, value_states = past_key_value.update_old(key_states, value_states, self.layer_idx, cache_kwargs)
        ...
        **kwargs,
        ...
        if self.self_attn.is_sliding:
            attention_mask = _create_causal_mask(
                position_ids=position_ids, target_length=past_key_value.sliding_window_len, sliding_window=past_key_value.sliding_window_len
            )
        else:
            attention_mask = _create_causal_mask(
                position_ids=position_ids,
    ...
    def forward(
        ...
        **flash_attn_kwargs,
        ...
        if use_cache and not isinstance(past_key_values, Cache):  # kept for BC (non `Cache` `past_key_values` inputs)
            ...
            past_key_values = QEffHybridCacheForGPTOSS.from_legacy_cache(config=self.config, past_key_values=past_key_values)
