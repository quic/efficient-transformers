...
class QEffGemmaAttention(GemmaAttention):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if kv_seq_len > QEffGemmaRotaryEmbedding._max_seq_len_cached:
            QEffGemmaRotaryEmbedding._set_cos_sin_cache(
...
class QEffGemmaModel(GemmaModel):
    ...
    def __qeff_init__(self):
        ...
        QEffGemmaRotaryEmbedding._max_seq_len_cached = self.config.max_position_embeddings
