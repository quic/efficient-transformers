...
class QEffQwen3Attention(Qwen3Attention):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if kv_seq_len > QEffQwen3RotaryEmbedding._max_seq_len_cached:
            QEffQwen3RotaryEmbedding._set_cos_sin_cache(
...
class QEffQwen3Model(Qwen3Model):
    ...
    def __qeff_init__(self):
        ...
        QEffQwen3RotaryEmbedding._max_seq_len_cached = self.config.max_position_embeddings
