...
class QEffLlama4TextExperts(Llama4TextExperts):
    def __qeff_init__(self):
        # HF fuses gate_up as [E, H, 2I] (concatenated halves) and keeps down [E, I, H].
        # Canonicalize to gate/up [E,H,I], down [E,I,H] for the shared MoE paths.
        ...
        # Backward-compatible aliases ([E,H,I] / [E,I,H]).
