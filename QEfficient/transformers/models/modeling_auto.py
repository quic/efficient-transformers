...
class QEFFAutoModel(QEFFTransformersBase):
    ...
    def model_hash(self) -> str:
        ...
        mhash.update(to_hashable(self.config.to_diff_dict()))
...
class _QEffAutoModelForImageTextToTextDualQPC:
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Method2
        self.specializations = model.get_specializations if hasattr(model, "get_specializations") else None
        self.output_names = model.get_output_names if hasattr(model, "get_output_names") else None
...
class _QEFFAutoModelForImageTextToTextSingleQPC(QEFFTransformersBase, MultimodalUtilityMixin):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        # Method 2
        self.inputs_info = self.model.get_inputs_info() if hasattr(self.model, "get_inputs_info") else None
        self.specializations = model.get_specializations if hasattr(model, "get_specializations") else None
        self.output_names = model.get_output_names if hasattr(model, "get_output_names") else None
...
class QEFFAutoModelForCausalLM(QEFFBaseModel):
    ...
    def model_hash(self) -> str:
        ...
        mhash.update(to_hashable({"qaic_config": self.qaic_config}))
        mhash.update(to_hashable(self._transform_names()))
        mhash.update(to_hashable(self.pretrained_model_name_or_path))
        mhash = mhash.hexdigest()[:16]
        return mhash
