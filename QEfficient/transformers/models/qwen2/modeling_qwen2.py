...
def _prepare_decoder_attention_mask(attention_mask, input_shape, inputs_embeds, past_key_values_length, cache_index):
    # create causal mask
        ...
        **kwargs,
        ...
        if past_key_value is not None:
            if cache_index is None:
                ...
                past_key_value[self.layer_idx][0][:, :, kv_indices] = key_states
                past_key_value[self.layer_idx][1][:, :, kv_indices] = value_states
...
class QEffQwen2Model(Qwen2Model):
    ...
    def forward(
        ...
        return QEffBaseModelOutputWithPast(
            ...
            attention_mask_RetainedState=pre_prepare_attention_mask if cache_index is not None else None,
        )
