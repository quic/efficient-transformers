...
class MiniMaxM3VLAttention(nn.Module):
    ...
    def __init__(self, config: MiniMaxM3VLTextConfig, layer_idx: int):
        ...
        self.indexer = (
            ...
            if config.layer_types[layer_idx] in {"minimax_m3_sparse", "sparse"}
            else None
        )
...
class MiniMaxM3VLVisionEmbeddings(nn.Module):
    ...
    def __init__(self, config) -> None:
        ...
        self.proj = nn.Conv3d(self.in_channels, self.embed_dim, kernel_size=kernel_size, stride=kernel_size, bias=False)
