...
@dataclass
class QEffBaseModelOutputWithPastAndCrossAttentions(ModelOutput):
    """
...
@dataclass
class QEffCausalLMOutputWithCrossAttentions(ModelOutput):
    """
...
@dataclass
class QEffBaseModelOutputWithPast(ModelOutput):
    """
    Base class for model's outputs that may also contain a past key/values (to speed up sequential decoding).
