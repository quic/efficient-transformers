...
from QEfficient.transformers.blocked_attention_utils import blocked_kv_attention_forward
...
class QBlockingStrategy(BlockingStrategy):
    def apply(self, *args, **kwargs):
        raise NotImplementedError("Q-blocking strategy is not implemented yet.")
