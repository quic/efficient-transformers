...
def main(
    ...
    tokenizer, model_path = load_hf_tokenizer(model_name=model_name, cache_dir=cache_dir, hf_token=hf_token, model_path=model_path)
    ...
    if qpc_path_exists:
        ...
        onnx_model_path = get_onnx_model_path(model_name, model_path, cache_dir, tokenizer, hf_token)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--model-path", "--model_path", required=False, help="Path to custom model")
    parser.add_argument(
        "--cache-dir",
        "--cache_dir",
