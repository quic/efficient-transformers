...
def cloud_ai_100_exec_kv(
    ...
    if full_batch_size is None:
        exec_info = [
            generate_text.cloud_ai_100_exec_kv_helper(prompt[i : i + batch_size], generation_len, stream, prompt_to_lora_id_mapping)
...
class TextGeneration():
    ...
    def setup(self, prompt: List[str], generation_len: Optional[int] = None,  prompt_to_lora_id_mapping: Optional[List[int]] = None):
    ...
    def cloud_ai_100_exec_kv_helper(self, prompt: List[str], generation_len: Optional[int] = None, stream: bool = True, prompt_to_lora_id_mapping: Optional[List[int]] = None):
        """
        ...
        """
        self.setup(prompt, generation_len, prompt_to_lora_id_mapping)
