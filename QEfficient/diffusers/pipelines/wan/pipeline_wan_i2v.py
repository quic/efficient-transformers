...
TODO: 1. Update umt5, vae encoder to Qaic; present running on cpu
"""
...
class QEffWanImageToVideoPipeline:
    ...
    Attributes:
        ...
        vae_encoder: VAE encoder for converting input images to latent space (TODO: QEfficient optimization)
    ...
    def __init__(self, model, **kwargs):
        ...
        self.text_encoder = model.text_encoder  # TODO: QAIC Support
        self.vae_encoder = model.vae.encode  # TODO QAIC Support
    ...
    def prepare_latents(
        ...
        if isinstance(generator, list):
            latent_condition = [
                retrieve_latents(self.vae_encoder(video_condition), sample_mode="argmax") for _ in generator
            ]
            latent_condition = torch.cat(latent_condition)
        else:
            latent_condition = retrieve_latents(self.vae_encoder(video_condition), sample_mode="argmax")
