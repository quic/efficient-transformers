...
class OnnxTransformPipeline(BaseOnnxTransform):
    ...
    def apply(
        ...
        **kwargs,
        ...
        # RewriteUnsupportedOpsTransform and SplitMultiInputMaxMinTransform are disabled
        # for the dynamo subfunction path — they are incompatible with the dynamo ONNX
        # graph structure. Re-enable when the transforms are updated for dynamo.
