...
class InputHandlerVLM:
    def __init__(
        ...
        # self.padding_shape = get_padding_shape_vlm(config, prompt_len, batch_size)
    ...
    ### TODO: 1+2 QPC works for mllama & llava
    ...
    # TODO: Check if it will work for dual qpc setup
    ...
    def update_vlm_ort_inputs(self, inputs, ort_outputs):
        ...
        # if "aspect_ratio_mask" in inputs.keys():
        #     updated_inputs["aspect_ratio_mask"] = inputs["aspect_ratio_mask"]
        # if "aspect_ratio_ids" in inputs.keys():
        #     updated_inputs["aspect_ratio_ids"] = inputs["aspect_ratio_ids"]
