...
def _setup_onnx_subfunctions(qeff_model, args, kwargs, dynamo=False):
    ...
    if dynamo:
        ...
        if ReduceSumAxesToAttrTransform not in qeff_model._onnx_transforms:
            qeff_model._onnx_transforms.append(ReduceSumAxesToAttrTransform)
