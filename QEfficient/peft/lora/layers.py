...
from QEfficient.customop import ctx_gather_cb
...
class LinearMultiLoRA(nn.Linear):
    ...
    def forward(self, x: torch.Tensor, lora_ids: torch.Tensor):
        ...
        selected_lora_a_weights = ctx_gather_cb(
        ...
        selected_lora_b_weights = ctx_gather_cb(
        ...
        selected_lora_scalings = ctx_gather_cb(
