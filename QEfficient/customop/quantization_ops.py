...
class UnpackUInt8ToUInt4(torch.autograd.Function):
    """
    ...
    ONNX symbolic    : emits UnpackUInt8ToUInt4Script node (com.qualcomm.cloud)
    ...
    def symbolic(g: torch.Graph, weight_packed: torch.Value) -> torch.Value:
        output = g.onnxscript_op(UnpackUInt8ToUInt4Script, weight_packed)
        return output
