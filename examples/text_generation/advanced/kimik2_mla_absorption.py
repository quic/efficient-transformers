...
#   None                                                                  Full PKV cache
#   {"blocking_mode": "h"}                                                Full PKV + head blocking
#   {"mla_absorption": mla_absorption}                                    No blocking
#   {"mla_absorption": mla_absorption, "replicate_kv_heads": True}        + KV-head replication
#   {"mla_absorption": mla_absorption, "blocking_mode": "kv"}
#   {"mla_absorption": mla_absorption, "blocking_mode": "kv", "replicate_kv_heads": True}
qaic_config = {
