...
def main():
    ...
    parser.add_argument("--generation-len", type=int, default=1024, help="Number of tokens to generate")
    ...
    model_blocked = QEFFAutoModelForCausalLM.from_pretrained(args.model_name, num_hidden_layers=4)
