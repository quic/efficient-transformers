...
decode_qaic_config = {
    ...
    "num_kv_blocks": 16,
    "num_batch_blocks": int(os.environ.get("QEFF_LINEAR_ATTN_NUM_BATCH_BLOCKS", "8")),
    "skip_kv": True,
    "moe_config": {
...
os.environ["QAIC_COMPILER_OPTS_UNSUPPORTED"] = (
    ...
    "-aic-hmx-async=0 -aic-userdma-async=0"
)
...
if enable_blocking:
    ...
    if decode_qaic_config.get("blocking_mode"):
        ...
        print(f"    Linear Attention Batch Blocks: {decode_qaic_config.get('num_batch_blocks')}")
