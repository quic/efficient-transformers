...
# Set True to enable linear blocking.
# Internally: chunk_size=64 and force_unroll_seq=PREFILL_SEQ_LEN.
enable_linear_blocking = False
qaic_config["enable_linear_blocking"] = enable_linear_blocking
