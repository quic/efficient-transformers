...
def run_model(
    ...
    model = QEFFAutoModelForImageTextToText.from_pretrained(model_name, token=token, kv_offload=kv_offload, torch_dtype=LOAD_DTYPE)
...
if __name__ == "__main__":
    ...
    # Get HF token from environment variable (None if not set)
