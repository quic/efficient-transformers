...
"""
Layerwise compile example for Qwen3-VL-MoE.
...
once first-class multi-window export lands. It is currently only supported for
``qwen3_vl_moe``, ``qwen3_5_moe`` and ``qwen3_moe``.
"""
